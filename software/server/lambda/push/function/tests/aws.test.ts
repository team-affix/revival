...
const lambdaFunctionArn = execSync(`cd ../../../../../infra/stacks/${stackEnv}/lambda && terraform output -raw package_push_lambda_invoke_arn`).toString().trim();
...
describe('AWS Lambda Invocation', () => {
    ...
    test(`aws sdk invocation should succeed for test package`, async () => {
